define(['questAPI'], function(Quest){
	...
	*/
    API.addQuestionsSet('basicQ',{
        ...
        helpText: 'Astuce : Vous pouvez double-cliquer sur votre réponse pour passer à la question suivante. Attention, vous ne pourrez pas revenir sur votre réponse précédente.'
